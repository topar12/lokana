            ...
            items: [
                {
                    icon: Stethoscope,
                    title: "진료 기준 일관성 확보",
                    desc: "- 원장의 처방 원칙과 진료 절차를 AI로 내재화\n- 신규 의료진도 동일 기준으로 즉시 진료 투입"
                },
                {
                    icon: FileHeart,
                    title: "증상 기반 처방 근거 검색",
                    desc: "- 증상·체질·이력 기반 유사 케이스 즉시 검색\n- 유사 사례 매칭으로 처방 판단 정확도 및 속도 향상"
                },
                {
                    icon: DatabaseZap,
                    title: "EMR 자동 연동",
                    desc: "- 전자의무기록(EMR) 시스템과 심리스한 연동\n- 데이터 중복 입력 제거로 업무 효율 극대화\n- 진료 데이터의 안전한 자산화"
                }
            ]
        },
        manufacturing: {
            ...
            items: [
                {
                    icon: Search,
                    title: "현장 문서 즉시 검색",
                    desc: "- 매뉴얼·도면·작업지시서 통합 검색 환경 구축\n- 현장 질의에 대한 즉각적인 AI 답변 제공"
                },
                {
                    icon: GitBranch,
                    title: "불량 원인 추적 단축",
                    desc: "- 과거 이력 및 유사 불량 패턴 자동 매칭\n- 원인 분석(RCA) 소요 시간 50% 이상 단축"
                },
                {
                    icon: LinkIcon,
                    title: "MES·ERP 실시간 연결",
                    desc: "- MES·ERP 레거시 시스템 데이터 파이프라인 연결\n- 현장 운영 데이터의 실시간 AI 반영"
                }
            ]
        }
    };
            ...
            <div className="relative z-10 mx-auto max-w-7xl px-6">
                ...
                <div className="mb-12 text-center">
                    <p className="mx-auto max-w-3xl text-sm leading-relaxed text-text-secondary">
                        의료·법률·금융·공공 등 데이터 보안과 도메인 맥락이 중요한 산업에도 동일한 구조로 확장됩니다.
                    </p>
                </div>
